...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div class="flex">
                <a href="{{ route('posts.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md mr-4">ADD Post</a>
            </div>
        </div>
    </x-slot>
                    ...
                    <table class="border-collapse table-auto w-full text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">Categories</th>
